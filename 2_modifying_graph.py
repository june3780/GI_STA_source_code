...
if __name__ == "__main__":
    ...
    print(wire_mode)
    print(def_name)
    file_pathtt='../data/deflef_to_graph_and_verilog/results/test_7800_'+wire_mode+'/'+file_name.split('_revised')[0]+'.json'
    with open(file_pathtt,'w') as f:
        json.dump(path,f,indent=4)

    '''print(delay_without_clk_All['dpath_sub_sub_752_15_g1050__1786 A1'])
    print()
    print(delay_without_clk_All['dpath_sub_sub_752_15_g1050__1786 A2'])
    print()
    print(delay_without_clk_All['dpath_sub_sub_752_15_g1050__1786 ZN'])
    print()'''

    
    file_pathpath='../data/deflef_to_graph_and_verilog/results/test_7800_without_clk_'+wire_mode+'/'+file_name.split('_revised')[0]+'.json'
    with open(file_pathpath,'w') as f:
        json.dump(delay_without_clk_All,f,indent=4)

    file_pathpath='../data/deflef_to_graph_and_verilog/results/test_7800_zfor_clk_'+wire_mode+'/'+file_name.split('_revised')[0]+'.json'
    with open(file_pathpath,'w') as f:
